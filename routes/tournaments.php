...
Route::middleware(['tournaments.tournamentaccess'])->group(function () {
    ...
    Route::prefix('/tournaments/{tournament}/rounds')->group(function () {
        ...
        Route::get('/teams', [RoundController::class, 'teams'])->name('tournaments.rounds.teams')->middleware('tournaments.news.pinned');
    ...
    Route::middleware(['tournaments.management'])->prefix('/tournaments/manage/{tournament}')->group(function () {
        ...
        Route::post('/publish', [TournamentManagementController::class, 'publish'])->name('tournaments.publish');
        ...
        Route::post('/rounds/{round}/publish', [RoundManagementController::class, 'publish'])->name('tournaments.rounds.publish');
