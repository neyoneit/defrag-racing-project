    ...
    <div class="bg-white/5 border border-white/10 rounded-xl transition-all duration-300 hover:border-blue-500/30">
        ...
        <div class="px-4 pb-4">
            <div v-if="!isEditing">
                ...
                <div class="flex items-start justify-between gap-3 mb-4">
                    <div class="flex-1">
                        ...
                        <p v-else class="text-gray-500 italic">{{ $t('No note added yet.') }}</p>
                    </div>
                    <button
            ...
            <form v-else @submit.prevent="saveNote">
                <!-- Position Input -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-300 mb-2">{{ $t('Clan Position') }}</label>
                    <input
                        type="text"
                        v-model="form.position"
                        :placeholder="$t('e.g., Leader, Co-Leader, Member, Recruit...')"
                ...
                <RichTextEditor
                    ...
                    :enable-table="false"
                    :enable-code="false"
                    :placeholder="$t('Add a note about this member...')"
                    min-height="8rem"
                />
                ...
                <div class="mt-4">
                    ...
                    >
                        ...
                        <span v-else>{{ $t('Upload Config (.cfg)') }}</span>
                    </button>
