    ...
    <div class="wiki-editor-wrapper">
        ...
        <div class="flex flex-wrap items-center gap-0.5 bg-gray-900/40 border border-gray-700/50 rounded-t-lg px-2 py-1.5">
            <template v-if="!sourceMode">
                ...
                <!-- Insert -->
                <button type="button" @click="addLink" :class="{ 'bg-blue-600/30 text-blue-400': editor?.isActive('link') }" class="toolbar-btn" :title="$t('Link')">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
                </button>
                <button type="button" @click="addImage" class="toolbar-btn" :title="$t('Image')">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                </button>
                <button type="button" @click="addTable" class="toolbar-btn" :title="$t('Table')">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" @click="insertLink" class="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition">
                                {{ linkUrl ? $t('Apply Link') : $t('Remove Link') }}
                            </button>
