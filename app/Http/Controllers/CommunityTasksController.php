...
class CommunityTasksController extends Controller
{
    ...
    {
        // Shared with the admin review screen - see DemoAssignmentContext. The
        // two used to assemble this separately and had already drifted.
        $context = app(DemoAssignmentContext::class)->for($demo);
        ...
        return [
            ...
            'closest_matches' => $context['closest'],
    ...
    {
        return app(DemoAssignmentContext::class)->resolveGametype($demo);
    }
